    ...
    <body>
												...
												<form action="#" method="post">
													<fieldset>
														...
														<div class="control-group">
															...
															<div class="controls">
                              <select class="" id='merchants' name="">
                                  ...
                                  require_once '../php/classes/merchant.class.php';
																	...
																	$merchants=$m->getMerchants();
																	//var_dump($merchants);

																	foreach($merchants as $merchant )
																	{
																		//echo "<options value='{$merchant}'>'{$merchant}'</options>";
																		//var_dump($merchant);
														...
														<button class="btn btn-inverse " id='submit'>Continue</button>
													</fieldset>
												</form>
											</div>
										</div>
     ...
     $(function(){
       //alert('bye');
             ...
             from=$('#username').val();
						 //A constant amount since this a just a prototype system
						 amount=100;
						 email=$('#merchants').val();
          //alert(email);

						 $.get("http://localhost/payment_gateway/php/api/v1/sendpayment.php?merchant="+email+"&from="+from+"&amount="+amount
					   , function( data ) {
